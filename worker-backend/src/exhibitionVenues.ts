...
export const EXHIBITION_VENUES: Record<string, ExhibitionVenue> = {
  ...
  "대전컨벤션센터": { lat: 36.3745, lng: 127.382, address: "대전 유성구 엑스포로 107" },
  "동대문디자인플라자": { lat: 37.5665, lng: 127.0093, address: "서울 중구 을지로 281" },
  "수원메쎄": { lat: 37.2519, lng: 126.9739, address: "경기 수원시 권선구 세화로134번길 37" },
  "수원컨벤션센터": { lat: 37.2897, lng: 127.0587, address: "경기 수원시 영통구 광교중앙로 140" },
  "창원컨벤션센터": { lat: 35.228, lng: 128.6811, address: "경남 창원시 성산구 원이대로 362" },
  "김대중컨벤션센터": { lat: 35.1526, lng: 126.8514, address: "광주 서구 상무누리로 30" },
  ...
  "부산항국제전시컨벤션센터": { lat: 35.1092, lng: 129.0399, address: "부산 동구 충장대로 206" },
  "울산전시컨벤션센터": { lat: 35.5346, lng: 129.1006, address: "울산 울주군 삼남읍 울산역로 255" },
  "청주 오스코": { lat: 36.6205, lng: 127.3287, address: "충북 청주시 흥덕구 오송읍 오송생명로 250" },
};
