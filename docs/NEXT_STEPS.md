...
2. 새 CDN 주소 GitHub iOS `34731831673` 빌드·테스트 성공. 실제 CI 정적 업로드 확인 후 TestFlight 업로드. 261은 기존 Worker 주소이므로 업데이트 필요.
3. 44시간 소스 순회/비공개 탈락 진단/원본 500·5,000 제한 제거 구현, Worker 347테스트 통과. 운영 배포 후 진단 파일과 실제 D1 사용량 관찰. IFEZ 페이지 순회와 공식 주최/행사장 소스 확장은 남음.
